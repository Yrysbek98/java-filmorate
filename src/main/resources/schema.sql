...
CREATE TABLE IF NOT EXISTS REVIEWS (
    ...
    CONSTRAINT r_user_id FOREIGN KEY (USER_ID) REFERENCES USERS(USER_ID),
    CONSTRAINT r_film_id FOREIGN KEY (FILM_ID) REFERENCES FILMS(FILM_ID)
);
...
CREATE TABLE IF NOT EXISTS EVENTS (
    ...
    CONSTRAINT e_user_id FOREIGN KEY (USER_ID) REFERENCES USERS(USER_ID)
);